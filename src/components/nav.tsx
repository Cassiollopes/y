...
export default function Nav({ user }: { user: User }) {
  ...
  return (
    <div className="flex max-2xl:justify-end md:py-1 xl:w-[15%] 2xl:w-[20.7%] max-md:-bottom-1 max-md:left-0 sticky md:top-0 z-[100] max-md:bg-black max-md:h-fit max-md:w-full max-md:justify-center">
      <div className="flex md:flex-col max-2xl:items-center max-md:w-full 2xl:w-full max-md:justify-center max-md:border-t max-md:gap-20 max-md:h-[52.5px]">
        <SideButton
      ...
      {showSignOut && (
        <>
          <button
            onClick={signOut}
            className="flex max-md:right-2 md:left-0 max-md:w-fit truncate max-md:bottom-36 -bottom-12 p-4 text-sm font-extrabold shadow-md rounded-2xl bg-background w-[300px] fixed md:absolute z-[200] hover:bg-zinc-900"
